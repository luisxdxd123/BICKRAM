...
if ($_POST) {
    ...
    $mail->setFrom('ignaciogauto14@gmail.com', 'BIKRAM - Acondicionamiento Físico');
    $mail->addReplyTo('ignaciogauto14@gmail.com', 'BIKRAM - Acondicionamiento Físico');
    ...
    $mail->Subject = '¡Atención! Pago pendiente para BIKRAM - Última oportunidad';
    ...
    $mail->Body = "
        ...
        <head>
            ...
            <title>¡Atención! Pago pendiente para BIKRAM - Última oportunidad</title>
            <style>
            body {
        ...
        <body>
            <div class='container'>
                <div class='content'>
                    <h1 class='title'>¡Atención! Pago pendiente para BIKRAM - Última oportunidad</h1>
                    <p class='message'>Estimado/a {$f->apecli} {$f->nomcli},</p>
                    <p class='message'>Le informamos que su pago para el servicio BIKRAM aún está pendiente. La fecha límite de pago es el <strong>{$f->fin}</strong>.</p>
                ...
                <div class='footer'>
                    <p class='signature'>Atentamente, El equipo de BIKRAM</p>
                    <p>Contacto: bikram@gnail.com / Teléfono: +52</p>
                    <p><a href='https://smafsebamontenegro.site/'>www.bikram.site</a></p>
                </div>
